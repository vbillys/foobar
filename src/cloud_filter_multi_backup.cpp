...
#define Z_CUT_LIMIT 0.5
    ...
    //int _ring_no_being_processed = 7; 
    for (int _ring_no_being_processed = 3; 
         _ring_no_being_processed < 16; 
        ...
        )
    {
      ...
      if (!_result.data_invalid)
      {
		  ...
		  {
			  printf("no right curb at ring %d ...\n", _ring_no_being_processed);
		  }
      }
      else
      {
		  printf("data invalid at ring %d ...\n", _ring_no_being_processed);
	  }
    }
    ++g_info_counter;
